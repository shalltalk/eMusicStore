...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            <h1>Edit Product</h1>
            <p class="lead">Edit the below information to update a product:</p>
        </div>

        <form:form action="${pageContext.request.contextPath}/admin/product/editProduct" mehthod="post" commandName="product" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCondition" id="category" value="new" />New</label>
            <label class="checkbox-inline"><form:radiobutton path="productCondition" id="category" value="used" />Used</label>
        </div>
